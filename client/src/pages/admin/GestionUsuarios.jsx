              ...
              <tr key={u.id}>
                ...
                <td>
                  <div className="actionButtons">
                    <button className="btnSecondary btnSmall" onClick={() => alert('Ver detalles (próximamente)')}>👁️ Ver</button>
                    <button className="btnPrimary btnSmall" onClick={() => alert('Editar (próximamente)')}>✏️ Editar</button>
                    {u.rol !== 'administrador' && (
                      <button className="btnDanger btnSmall" onClick={() => handleEliminar(u.id, `${u.nombre} ${u.apellido || ''}`)}>🗑️ Eliminar</button>
                    )}
                  </div>
                </td>
              </tr>
